...
def _thinking_enabled_from_env() -> bool:
    value = os.getenv(
...
class DeepSeekProvider:
    ...
    def _request(
        ...
        if not isinstance(payload, dict):
            raise TerminalDeepSeekError(
                "DeepSeek JSON root must be object"
            )
